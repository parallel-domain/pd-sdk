...
_POINTCLOUD_CHANNELTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(name="INTENSITY", index=3, number=3, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="R", index=4, number=4, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="G", index=5, number=5, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="B", index=6, number=6, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="RING", index=7, number=7, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="NORMAL_X", index=8, number=8, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="NORMAL_Y", index=9, number=9, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="NORMAL_Z", index=10, number=10, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="CLASS_ID", index=11, number=11, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="INSTANCE_ID", index=12, number=12, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="TIMESTAMP", index=13, number=13, serialized_options=None, type=None),
    ],
...
_POINTCLOUD_ANNOTATIONSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="dgp.proto.PointCloud.AnnotationsEntry.key",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="dgp.proto.PointCloud.AnnotationsEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_POINTCLOUD_METADATAENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="dgp.proto.PointCloud.MetadataEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="dgp.proto.PointCloud.MetadataEntry.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_POINTCLOUD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="filename",
            full_name="dgp.proto.PointCloud.filename",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="annotations",
            full_name="dgp.proto.PointCloud.annotations",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="metadata",
            full_name="dgp.proto.PointCloud.metadata",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="point_format",
            full_name="dgp.proto.PointCloud.point_format",
            index=3,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="point_fields",
            full_name="dgp.proto.PointCloud.point_fields",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="pose",
            full_name="dgp.proto.PointCloud.pose",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _POINTCLOUD_ANNOTATIONSENTRY,
        _POINTCLOUD_METADATAENTRY,
    ],
    enum_types=[
...
_POINTCLOUD.fields_by_name["pose"].message_type = geometry__pb2._POSE
