...
_ANNOTATIONTYPE = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="BOUNDING_BOX_2D", index=0, number=0, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="BOUNDING_BOX_3D", index=1, number=1, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name="SEMANTIC_SEGMENTATION_2D", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SEMANTIC_SEGMENTATION_3D", index=3, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="INSTANCE_SEGMENTATION_2D", index=4, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="INSTANCE_SEGMENTATION_3D", index=5, number=5, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(name="DEPTH", index=6, number=6, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name="SURFACE_NORMALS_2D", index=7, number=13, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SURFACE_NORMALS_3D", index=8, number=7, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="MOTION_VECTORS_2D", index=9, number=8, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="MOTION_VECTORS_3D", index=10, number=9, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(name="KEY_POINT_2D", index=11, number=10, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="KEY_LINE_2D", index=12, number=11, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="POLYGON_2D", index=13, number=12, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="AGENT_BEHAVIOR", index=14, number=14, serialized_options=None, type=None),
    ],
...
_BOUNDINGBOX3D.fields_by_name["pose"].message_type = geometry__pb2._POSE
