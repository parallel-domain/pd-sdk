...
_SCENETYPE = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="SYNTHETIC_SCENE", index=0, number=0, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="URBAN", index=1, number=1, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="SUBURBAN", index=2, number=2, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="HIGHWAY", index=3, number=3, serialized_options=None, type=None),
    ],
...
_REGIONTYPE = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="SYNTHETIC_REGION", index=0, number=0, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name="NORTHERN_CALIFORNIA", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(name="MICHIGAN", index=2, number=2, serialized_options=None, type=None),
    ],
    containing_type=None,
    serialized_options=None,
