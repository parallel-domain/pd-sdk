...
from paralleldomain.model.annotation import AnnotationTypes, SceneFlow
from paralleldomain.utilities import fsio
from paralleldomain.utilities.any_path import AnyPath


class SceneFlowDGPV1Mixin(CommonDGPV1FormatMixin):
    def save_scene_flow_and_write_state(
        self,
        data: Union[SceneFlow, AnyPath],
        ...
        pipeline_item.custom_data[CUSTOM_FORMAT_KEY][ANNOTATIONS_KEY][
            str(self._annotation_type_map_inv[AnnotationTypes.SceneFlow])
        ] = save_path
        return save_path
