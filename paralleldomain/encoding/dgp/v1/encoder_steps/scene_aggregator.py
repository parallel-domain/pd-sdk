...
from paralleldomain.encoding.pipeline_encoder import SceneAggregator, T
from paralleldomain.utilities.any_path import AnyPath
from paralleldomain.utilities.fsio import relative_path, write_json_message


class DGPV1SceneAggregator(SceneAggregator[Dict[str, Any]]):
    ...
    def aggregate(self, scene_info: Dict[str, Any]):
