...
from paralleldomain.decoding.flying_things.common import get_scene_flow_folder, get_scene_folder, read_flow
...
class FlyingThingsCameraSensorFrameDecoder(CameraSensorFrameDecoder[datetime]):
    ...
    def _decode_available_annotation_types(
        ...
        optical_flow_file_name = f"{sensor_name}/{frame_id}.pfm"
    ...
    def _decode_optical_flow(self, scene_name: str, frame_id: FrameId, annotation_identifier: str) -> np.ndarray:
        ...
        flow = read_flow(file_path=annotation_path)
        return flow
