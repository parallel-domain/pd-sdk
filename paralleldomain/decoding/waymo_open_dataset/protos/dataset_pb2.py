...
import paralleldomain.decoding.waymo_open_dataset.protos.label_pb2 as label__pb2
...
_CAMERANAME_NAME = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(name="FRONT_RIGHT", index=4, number=4, serialized_options=None, type=None),
