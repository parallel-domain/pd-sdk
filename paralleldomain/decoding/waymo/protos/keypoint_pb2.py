...
_VEC2D = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="waymo.open_dataset.keypoints.Vec2d.x",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="waymo.open_dataset.keypoints.Vec2d.y",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
...
_VEC3D = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="x",
            full_name="waymo.open_dataset.keypoints.Vec3d.x",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="y",
            full_name="waymo.open_dataset.keypoints.Vec3d.y",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="z",
            full_name="waymo.open_dataset.keypoints.Vec3d.z",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
...
Vec2d = _reflection.GeneratedProtocolMessageType(
    "Vec2d",
    (_message.Message,),
    dict(
        DESCRIPTOR=_VEC2D,
...
Vec3d = _reflection.GeneratedProtocolMessageType(
    "Vec3d",
    (_message.Message,),
    dict(
        DESCRIPTOR=_VEC3D,
