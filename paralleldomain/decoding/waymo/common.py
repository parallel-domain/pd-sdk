...
from paralleldomain.decoding.waymo.protos import camera_segmentation_pb2 as cs_pb2
from paralleldomain.decoding.waymo.protos import dataset_pb2
    ...
    with record_path.open("rb") as file:
        while file:
            ...
            if read_frame:
                ...
                # datacrc = struct.unpack("I", file.read(4))
