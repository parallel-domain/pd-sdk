...
class StackAndFlyBehaviour(StackBehaviour):
    ...
    def set_inital_state(
        ...
        super().set_inital_state(sim_state=sim_state, agent=agent, random_seed=random_seed)
...
class MyObstacleGenerator(data_lab.CustomAtomicGenerator):
    ...
    def clone(self) -> "MyObstacleGenerator":
...
scenario.environment.time_of_day.set_category_weight(data_lab.TimeOfDays.Night, 0.0)
...
#     scenario=scenario,
#     ig_version="v1.14.0",
#     step_url="ssl://step-api.paralleldomain.com:3001",
#     frames_per_scene=20,
#     sim_capture_rate=1,
#     number_of_scenes=1,
#     format_kwargs=dict(
#         dataset_output_path="/tmp/debug-mini5/",
...
data_lab.preview_scenario(
    ...
    # ig_version="v1.14.0",
    # step_url="ssl://step-api.paralleldomain.com:3001",
    # pd_sim_address="tcp://35.88.45.73:9002",
    frames_per_scene=20,
    # sim_capture_rate=25,
    # show_image_for_n_seconds=0.01,
)
