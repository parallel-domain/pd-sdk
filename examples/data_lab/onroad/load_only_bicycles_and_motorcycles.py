...
def bicycle_motorcycle_only_distribution() -> Dict[str, VehicleCategoryWeight]:
    spawn_only_categories = ["BICYCLE", "MOTORCYCLE"]
...
vehicle_weights = bicycle_motorcycle_only_distribution()
