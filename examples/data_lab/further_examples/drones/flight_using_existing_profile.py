...
class ExistingProfileFlight(ScenarioCreator):
    def create_scenario(
        ...
        # this could be done in the EgoDroneBehavior itself, but we need to pass the XYZ
        # coordinates to PD generators, so we do it outside.
...
if __name__ == "__main__":
    preview_scenario(
        scenario_creator=ExistingProfileFlight(),
